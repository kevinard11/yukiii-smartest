    ...
    for child in node.children:
        ...
        if child.type == "function_declaration":
            ...
            if function_name and function_body:
                ...
                edges = [1]
                statement_count = [0]
                extract_operators_operands_from_tree(function_body, operators, operands, nodes, edges, statement_count)
...
# Fungsi untuk mengekstrak operator & operan hanya dari tree
def extract_operators_operands_from_tree(node, operators, operands, nodes, edges, statement_count):
    # print(nodes)
    if node.type in ["binary_expression", "assignment_expression", "unary_expression", "logical_expression"]:
        # Operator ditemukan sebagai child pertama dari binary/unary expression
        ...
        # Variabel atau fungsi dianggap sebagai operan
...
# tree_contents = _extract_from_dir("./example/js/test", _parse_tree_content, "js")
# print(tree_contents)
